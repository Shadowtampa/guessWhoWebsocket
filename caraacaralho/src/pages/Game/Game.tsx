...
// const image_link = 'https://cdn.nekosapi.com/images/original/ae4e550a-c638-46ba-b191-d05421881058.webp'
...
export const Game = () => {
    ...
    const [cards, setCards] = useState(
        [
            {
                id: 1,  // Adiciona um ID único para cada card
                name: `Hatsune, Miku`,  // Define o nome como o ID do card
                image: 'https://cdn.nekosapi.com/images/original/9175638b-c8a1-4f8e-9b3e-cb903c3c44a1.webp',  // Substitua 'image_link' pelo seu link de imagem
                flipped: true
            },
            {
                id: 2,  // Adiciona um ID único para cada card
                name: `Shinomiya, Kaguya`,  // Define o nome como o ID do card
                image: 'https://cdn.nekosapi.com/images/original/2a927eed-db4c-4483-8198-2daad37d6eac.webp',  // Substitua 'image_link' pelo seu link de imagem
                flipped: true
            },{
                id: 3,
                name: 'Megumin',
                image: "https://cdn.nekosapi.com/images/original/60c1e16b-d936-48f5-88f6-5b954e5889fc.webp",
                flipped: true
            }
